		...
		return (
			<div className="team">
				...
				<section className="wh">
					...
					<p className="vincent">
						I really enjoy the front end side of developing but I am
						always looking to learn and incorporate new things. My
						portfolio is a work in progress but feel free to check it out:{' '}
						<a
