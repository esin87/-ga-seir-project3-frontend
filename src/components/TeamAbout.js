			...
			<div className='team'>
				...
				<section>
					...
					<p className='top'>
						...
						trying to be clever with something like Kenny's G-Suite or Kenny
						Rogers Roasted Coders, but this combo had us the most entertained
						and happy.{' '}
						<a
				...
				<section className='wh'>
					...
					<p className='brian'>
						Just starting my journey on this side of the interwebs. I enjoy the
						puzzle like challanges faced when compiling code. I would love to
						crack into the gaming world someday.{' '}
						<a
					...
					<p className='eleni'>
						I enjoy being Fullstack Software Engineer continually learning new
						languages and solving problems. This project was a lot of fun to
						create.{' '}
						<a
					...
					<p className='esin'>
						I love using my fullstack knowledge to create applications that make
						people happier. My previous experiences in education and healthcare
						have helped me to realize my true passion: using technology to solve
						problems.{' '}
						<a
					...
					<p className='vincent'>
						I am a fullstack developer with a passion for the front end side of
						developing but I am always looking to learn and incorporate new
						things. My portfolio is a work in progress but feel free to check it
						out:{' '}
						<a
